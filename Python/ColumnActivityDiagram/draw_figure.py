...
# python draw_figure.py -fn "C:\Users\HP\source\repos\neocortexapi\Python\ColumnActivityDiagram\sampleOne.txt" -gn test1 -mc 414  -ht 8 -yt yaxis -xt xaxis -min 50 -max 4000 -st 'single column' -fign CortialColumn -a
